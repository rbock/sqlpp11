...
// generated by ./scripts/ddl2cpp -auto-id -with-table-creation-helper tests/include/sqlpp11/tests/postgresql/tables.sql tests/include/sqlpp11/tests/postgresql/tables test
